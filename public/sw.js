// Service Worker for Spaders Waterproofing
// Version: 1.0.0
// Enables offline functionality and improves performance

const CACHE_NAME = 'spaders-v1.0.0';
const urlsToCache = [
  '/',
  '/styles/critical.css',
  '/manifest.json',
...
self.addEventListener('push', (event) => {
  const options = {
    body: event.data ? event.data.text() : 'New update from Spaders Waterproofing',
  ...
  event.waitUntil(
    self.registration.showNotification('Spaders Waterproofing', options)
  );
});