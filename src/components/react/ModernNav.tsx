...
const resources = [
  ...
  { title: "Flood Risk Checker", href: "/tools/flood-risk-checker" },
  { title: "Permit Checker", href: "/tools/permit-checker" },
  { title: "Method Comparison", href: "/tools/method-comparison" },
